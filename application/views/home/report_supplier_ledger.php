                        ...
                        <table class="table table-bordered table-striped table-hover">
                            <thead>
                                ...
                                if ($sledger->supplier_transaction_type == "Debit(+)") {
                                        $debit_amount = $sledger->supplier_transaction_amount;
                                        $credit_amount = 0;
                                        $balance += $debit_amount;
                                    }else if ($sledger->supplier_transaction_type == "Credit(-)"){
                                        $debit_amount = 0;
                                        $credit_amount = $sledger->supplier_transaction_amount;
                                ...
                                ?>
                                <tr>
                                    <td><?php echo date('d/m/Y', strtotime($sledger->supplier_transaction_date));?></td>  
                                    <td><?php echo $sledger->supplier_name;?></td> 
                                     <td><?php echo $sledger->supplier_org;?></td> 
                                     <td><?php echo $sledger->supplier_mobile;?></td> 
                                    <td><?php echo $sledger->supplier_transaction_description;?></td> 
                                    ...
                                    <td align="right"><?php echo number_format((float)$balance, 2, '.', '');?></td>
                                     <td class="no-print"><a class="btn btn-success btn-xs" href="<?php echo base_url() . "supplier-payment-receipt/" . $sledger->supplier_ledger_id; ?>">Receipt</a></td> 
                                </tr>
