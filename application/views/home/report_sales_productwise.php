      ...
      <div class="card">
        ...
        <div class="card-body table-responsive">
          ...
          <div id="printableArea" style="margin-left:2px;">
                                ...
                                <tbody>
                                     <?php 
                                        ...
                                        foreach($sales_info as $item){
                                            ...
                                            $discount = $item->sales_item_discount;
                                            
                                            $total = $item->sales_item_rate*$qty;
                                     ...
                                     ?>
                                        <tr>
                                            <td><?php echo $x++;?></td>
                                            <td>
                                                <?php echo date("d/m/Y", strtotime($item->sales_invoice_date)); ?>
                                            </td>
                                            <td><a target="_blank" href="<?php echo base_url() . "sales-detail/". $item->sales_invoice_id; ?>"><?php echo $item->sales_invoice_no;?></a></td>
                                            <td><?php echo $item->customer_name;?></td>
                                            <td><?php echo $item->customer_organization;?></td>
                                            <td align="right"><?php echo $item->sales_item_rate;?></td>
                                            <td align="right"><?php echo $qty." ".$item->unit_name;?></td>
                                            
                                            <td align="right"><?php echo number_format((float)$total, 2, '.', '');?></td>
                                            <td align="right"><?php echo number_format((float)$vat, 2, '.', '');?></td>
                                     ...
                                     <tr>
                                        ...
                                        <td align="right"><?php echo number_format((float)$sales_total, 2, '.', '');?></td>
                                        <td align="right"><?php echo number_format((float)$vat_total, 2, '.', '');?></td>
                        ...
                        <?php }else{ echo "No sales Information Found!";} ?><br>
