                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <td align="right">
                      <?php echo number_format((float)$net_payable, 2, '.', '');?>
                      <input type="hidden" class="form-control bill_cal" name="net_payable[]" step="0.01" value="<?php echo number_format((float)$net_payable, 2, '.', '');?>" min="0" readonly>
                    </td>
                    <td align="right">
                      <?php echo number_format((float)$net_paid, 2, '.', '');?>
                      <input type="hidden" class="form-control bill_cal" name="net_paid[]" step="0.01" value="<?php echo number_format((float)$net_paid, 2, '.', '');?>" min="0" readonly>
                    </td>
                    <td align="right">
                       <?php echo number_format((float)$due, 2, '.', '');?>
                      <input type="hidden" class="form-control bill_cal" name="due_amount[]" step="0.01" value="<?php echo number_format((float)$due, 2, '.', '');?>" min="0" readonly>
                    </td>
                    <td align="right">
                    ...
                    <td align="right">
                     <input type="number" class="form-control bill_cal" name="balance_due[]" step="0.01" value="<?php echo number_format((float)$due, 2, '.', '');?>" min="0" readonly>
                    </td>
                    <td>
