<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Client</h1><small>Reniew Form<b class="box-title" style="color:red;"> ( * ) Marked Fields are Required.</b></small>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="content">
      <form class="form-horizontal" id="" action="<?php echo base_url() . "update-reniew-client/" . $clients_info->client_id; ?>" method="post" enctype="multipart/form-data"  role="form">
      <div class="card">
        <div class="card-body table-responsive">
          ...
          <div class="form-group row col-sm-6">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control  pull-right datepicker" id="reg_date" name="reg_date" value="<?php echo $clients_info->registration_date; ?>" data-date-format='yyyy-mm-dd' placeholder="yyyy-mm-dd" required autocomplete="off" disabled>
          ...
          <div class="form-group row col-sm-6">
            ...
            <div class="col-sm-6">
              ...
              <span style="color:red;font-size: 10px;float: left;"><?php echo form_error('exp_date'); ?></span>
					...
					<div class="form-group row col-sm-6">
            <label for="exp_date" class="col-sm-4 col-form-label">New Expire Date<span class="text-red">*</span></label>
            <div class="col-sm-6">
              <input type="date" class="form-control  pull-right" id="new_exp_date" name="new_exp_date" value="" required autocomplete="off">
              <span style="color:red;font-size: 10px;float: left;"><?php echo form_error('new_exp_date'); ?></span>
            </div>
          </div>
          <div class="form-group row col-sm-6">
