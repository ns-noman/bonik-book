    ...
    <section class="content">
     <div class="card">
        <div class="card-body  table-responsive">
          ...
          <?php echo $error_msg; ?>
           <form class="form-horizontal" action="<?php echo base_url() . "add-purchase-return/".$purchase_info->purchase_invoice_id; ?>" method="post" enctype="multipart/form-data"  role="form" id="purchase_form">
                   
                        <div class="row">
                            <div class="col-sm-4">
                                    <label class="col-form-label">Supplier : <?php echo $purchase_info->supplier_name; ?></label>
                            </div>

                             <div class="col-sm-4">
                                    <label class="col-form-label">Purchase Date : <?php echo $purchase_info->purchase_invoice_date; ?></label>
                            </div>
                            ...
                            <div class="col-sm-4">
                                    <label class="col-form-label">Challan No : <?php echo $purchase_info->purchase_challan_no; ?></label>
                            </div>

                            <div class="col-sm-4">
                                    <label class="col-form-label">Purchase Invoice : <?php echo $purchase_info->purchase_invoice_no; ?></label>
                            </div>

                            <div class="col-sm-4">
                                    <label class="col-form-label">Details : <?php echo $purchase_info->purchase_invoice_detail; ?></label>
                            </div>

                            <div class="col-sm-4" id="payment_from_1">
                                    <label for="payment_type" class="col-form-label">Payment Info : <?php echo $purchase_info->purchase_payment_type; ?> Payment. <?php echo $purchase_info->purchase_payment_info; ?></label>
                             </div>
                        </div>
                ...
                <table class="table table-bordered table-striped table-hover" id="purchase_return_table">
                    <thead>
                        <tr>
                            <th>SL</th>
                            <th>Code</th>
                            ...
                            <th>Return Qty</th>
                            <th>Unit</th>
                            <th>Purchase Price (Include Discount)</th>
                    ...
                    <tbody>
                        ...
                        foreach($purchase_item as $item){
                            $unit_discount = $item->purchase_item_discount / $item->purchase_item_quantity;
                            $return_rate = $item->purchase_item_rate-$unit_discount;
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" class="form-control" name="purchase_item[]" value="<?php echo $item->purchase_item_id; ?>" readonly>
                            </td>
                            <td>
                                <input type="number" class="form-control purchase_cal" name="purchase_qty[]" value="<?php echo $qty;?>" min="1" required readonly>
                            </td>
                            <td>
                            ...
                            <td>
                                <input type="number" class="form-control purchase_cal" name="return_qty[]" value="0" min="0" max="<?php echo $qty;?>">
                            </td>
                            <td>
                                <input type="text" class="form-control" name="unit[]" value="<?php echo $item->unit_name;?>" readonly>
                            </td>
                            <td>
                                <input type="number" class="form-control purchase_cal" name="unit_price[]" value="<?php echo number_format((float)$return_rate, 2, '.', '');?>" step="0.01" required readonly>
                            </td>
                            <td>
                                <input type="number" class="form-control purchase_cal" name="purchase_return_rate[]" value="<?php echo number_format((float)$return_rate, 2, '.', '');?>" step="0.01" required max="<?php echo $return_rate;?>">
                            </td>
                    ...
                    <tfoot style="text-align: right; font-size: 14px;">
                        ...
                        <tr>
                            <td>
                                Special Discount:
                                <?php $invoice_discount_rate = ($purchase_info->purchase_invoice_discount/($purchase_info->purchase_total_amount-$purchase_info->purchase_total_discount))*100;
                                echo "(".number_format((float)$invoice_discount_rate, 2, '.', '')."%)";
                                 ?>
                            </td>
                            <td colspan="4">
                                <input type="number" class="form-control purchase_cal" name="invoice_discount" id="invoice_discount" step="0.01" value="0" readonly>
                                <input type="hidden" name="discount_per" id="discount_per" value="<?php echo $invoice_discount_rate; ?>" >
                            </td>
                        </tr>
                        <tr>
                            <td>Paid Amount:</td>
                            <td>
                                <input type="number" class="form-control purchase_cal" name="paid_amount" id="paid_amount" step="0.01" value="<?php  echo  number_format((float)$paid_amount, 2, '.', ''); ?>" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td>Current Due:</td>
                            <td>
                                <input type="number" class="form-control purchase_cal" name="due" id="due" step="0.01" value="<?php  echo  number_format((float)$due, 2, '.', ''); ?>" readonly>
                            </td>
                        </tr>
                        <!-- <tr>
                            <td>Due Amount:</td>
                            <td>
                                <input type="text" class="form-control" name="purchase_due" id="purchase_due" value="<?php  echo  number_format((float)$due, 2, '.', ''); ?>" readonly>
                            </td>
                        </tr> -->
                        <tr>
                            <td>Return Amount:</td>
