<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Pending Sales Requisition List</h1>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="card-body table-responsive">
          ...
          <?php echo $error_msg; ?>
            <?php if ($sales_info){ ?>
              ...
              <caption>Pending Sales Requisition List</caption>
                <thead>
                <tr>
                  <th width="30">SL.</th>
                  <th>Issue Date</th>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-primary btn-xs" href="<?php echo base_url() . "sales-requisition-detail/". $info->sales_req_id; ?>">
                         view
                      </a>
