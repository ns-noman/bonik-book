                            ...
                            <?php 
                                 if($return){ 
                                    ...
                                    <tr>
                                        ...
                                        <td align="right">0</td>  
                                        <td align="right"><?php echo number_format($preturn->purchase_return_total, 2, '.', ',');?></td>
                                        
                                        <td align="right"><?php echo number_format($balance -= $preturn->purchase_return_total, 2, '.', ',');?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $preturn->supplier_mobile;?></td>   
                                        <td><a target="_blank" href="<?php echo base_url() . "purchase-return-detail/". $preturn->purchase_return_id; ?>"><?php echo $preturn->purchase_invoice_no;?></a> (Return)</td>
                                        <td align="right"><?php echo number_format($preturn->purchase_return_amount, 2, '.', ',');?></td>  
                                        <td align="right">0</td>
                                        
                                        <td align="right"><?php echo number_format($balance += $preturn->purchase_return_amount, 2, '.', ',');?></td>
                                    </tr>
