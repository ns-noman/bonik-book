        ...
        <div class="card-body table-responsive" id="printableArea">
          ...
          <div class="row">
                    ...
                    <div class="row">
                            ...
                            <div class="col-3 col-sm-3">
                                    <label class="form-label">Payment Date: <?php echo date("d/m/Y", strtotime($payment_info->customer_transaction_date)); ?></label></label>
                            </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo $payment_info->customer_transaction_description; ?></td>
                            <td align="right"><?php echo number_format((float)$payment_info->customer_transaction_amount, 2, '.', '');?></td>
                        </tr>
