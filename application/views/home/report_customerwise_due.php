                    ...
                    <center><h4><?php echo $title; ?></h4></center>
                        <table class="table table-bordered table-striped table-hover">
                            <thead>
                                ...
                                <?php 
                                    $x = 1;
                                    //$due = $this->inventory_model->get_customer_due($customer_info->customer_id);
                                    $sales_total = $due->sales_total_amount+$due->sales_total_vat-($due->sales_invoice_discount+$due->sales_total_discount)
                               ...
                               if ($due_total> 0) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $customer_info->customer_mobile;?></td>
                            ...
                            <?php }  ?>
                                <tr style="font-weight:bold; background-color: #dfdfdf;">
                                    ...
                                    <td align="right"><?php echo number_format((float)$due_total, 2, '.', '');?></td>  
                                </tr>
                            </thead>
                            <tbody>
