<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Profile</h1><small><b class="box-title" style="color:red;"> ( * ) Marked Fields are Required.</b></small>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="content">
      <form class="form-horizontal" id="" action="<?php echo base_url() . "update-profile/" . $clients_info->client_id; ?>" method="post" enctype="multipart/form-data"  role="form">
      <div class="card">
        <div class="card-body table-responsive">
          ...
          <div class="form-group row col-sm-6">
            <label for="reg_date" class="col-sm-4 col-form-label">Package Name</label>
            <div class="col-sm-6">
              <input type="text" class="form-control  pull-right datepicker" id="package_name" name="package_name" value="<?php echo $clients_info->package_name; ?>" disabled>
          ...
          <div class="form-group row col-sm-6">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control  pull-right" id="package_price" name="package_price" value="<?php echo $clients_info->package_price;?>" required autocomplete="off" readonly>
              <span style="color:red;font-size: 10px;float: left;"><?php echo form_error('exp_date'); ?></span>
            </div>
          </div>
					<div class="form-group row col-sm-6">
            <label for="reg_date" class="col-sm-4 col-form-label">Start Date</label>
            <div class="col-sm-6">
              <input type="text" class="form-control  pull-right datepicker" id="reg_date" name="reg_date" value="<?php echo $clients_info->registration_date; ?>" disabled>
							<span style="color:red;font-size: 10px;float: left;"><?php echo form_error('reg_date'); ?></span>
            </div>
          </div>
          <div class="form-group row col-sm-6">
            <label for="exp_date" class="col-sm-4 col-form-label">Expire Date</label>
            <div class="col-sm-6">
