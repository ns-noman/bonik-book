                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" name="sales_details" id="sales_details" placeholder=" Details" rows="1"><?php echo $sales_info->sales_req_detail; ?></textarea>
                                    </div>
                                </div> 
                            </div>
                        </div>
                ...
                <table class="table table-bordered table-striped table-hover" id="sales_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" class="form-control sales_cal" name="sales_discount[]" value="0" step="0.01">
                            </td>
                            <td colspan="2">
                     ...
                     <tfoot style="text-align: right;">
                        ...
                        <tr>
                            <td>Paid Amount:</td>
                            <td colspan="4">
                                <input type="number" class="form-control sales_cal" name="paid_amount" id="paid_amount" step="0.01" value="0">
                            </td>
                        </tr>
                        <tr>
                            <td>Due:</td>
                      ...
                      <!--   <tr>
                        ...
                        <tr>
                           <td colspan="11"><button type="submit" class="btn btn-primary">Submit</button></td>
                           <td></td> 
                        </tr>
                    </tfoot>
                </table>
