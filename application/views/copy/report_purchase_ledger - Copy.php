                        ...
                        <table class="table table-bordered table-striped table-hover">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $ledger->supplier_org;?></td>  
                                    <td><?php echo $ledger->supplier_mobile;?></td>  
                                ...
                                <?php $return = $this->inventory_model->get_datwise_purchase_return($ledger->purchase_invoice_date);
                                 if($return){ 
                                    foreach ($return as $preturn) {
                                        $debit_total +=  $preturn->purchase_return_amount;
                                        $credit_total += $preturn->purchase_return_total;
                                        ?>
                                    <tr>
                                        <td><?php echo date('d/m/Y', strtotime($preturn->purchase_return_date));?></td>  
                                        <td><?php echo $preturn->supplier_name;?></td> 
                                         <td><?php echo $preturn->supplier_org;?></td>  
                                        <td><?php echo $preturn->supplier_mobile;?></td>   
                                        ...
                                        <td align="right">0</td>  
                                        <td align="right"><?php echo number_format((float)$preturn->purchase_return_total, 2, '.', '');?></td>
                                        
                                        <td align="right"><?php echo number_format((float)$balance -= $preturn->purchase_return_total, 2, '.', '');?></td>
                                    </tr>
                                    <tr>
                                    <td><?php echo date('d/m/Y', strtotime($preturn->purchase_return_date));?></td>  
                                    <td><?php echo $preturn->supplier_name;?></td>  
                                ...
                                <?php } } ?>
                                <?php $due_collection = $this->inventory_model->get_datwise_purchase_due_collection($ledger->purchase_invoice_date); 
                                if ($due_collection) {
                                ...
                                <!-- <tr>
                                    ...
                                    <td><a target="_blank" href="<?php echo base_url() . "supplier-payment-detail/". $duec->supplier_payment_id; ?>"><?php echo $duec->purchase_invoice_no;?> (Due Collection)</a></td>
