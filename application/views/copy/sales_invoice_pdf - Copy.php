<!-- Main content -->
    ...
    <section class ="invoice">
      ...
      <table cellspacing="0" cellpadding="0" width="200" style="font-size:11px;">
          ...
          <table  cellspacing="0" cellpadding="2" width="200" style="font-size:11px;">
           ...
           <tr>
            ...
            <tr>
              ...
              <td align="right"><?php echo number_format((float)$item->sales_item_amount, 2, '.', '');?></td>
            </tr>
            <?php }}else{ echo "No data  found!";} ?>
            <tr>
                <td colspan="4" align="right" style="border-top:solid 0.5px #000;"><b>Total Amount:</b></td>
                <td align="right" style="border-top:solid 0.5px #000;"><b><?php echo number_format((float)$sales_info->sales_total_amount, 2, '.', ''); ?></b>
                </td>
            </tr>
            <tr>
                <td colspan="4" align="right" style="border-top:solid 0.5px #000;"><b>Total VAT:</b></td>
                <td align="right" style="border-top:solid 0.5px #000;"><b><?php echo number_format((float)$total_vat, 2, '.', ''); ?></b>
                </td>
            </tr>
            <tr>
                <td colspan="4" align="right" style="border-bottom:solid 0.5px #000;"><b>Discount Amount:</b></td>
                <td align="right" style="border-bottom:solid 0.5px #000;"><b><?php echo number_format((float)$sales_info->sales_invoice_discount+$sales_info->sales_total_discount, 2, '.', ''); ?></b>
                </td>
            </tr>
            <tr>
                <td colspan="4" align="right" style="border-bottom:solid 0.5px #000;"><b>Payable Amount:</b></td>
                <td align="right" style="border-bottom:solid 0.5px #000;"><b><?php echo number_format((float)$total, 2, '.', ''); ?></b>
                </td>
            </tr>
            <tr>
                <td colspan="4" align="right"><b>Paid Amount:</b></td>
                <td align="right"><b><?php echo  number_format((float)$sales_info->sales_amount_paid, 2, '.', ''); ?></b>
                </td>
            </tr>
            <?php if ($sales_info->sales_amount_paid > $total){ ?>
            <tr>
                <td colspan="4" align="right"><b>Advance:</b></td>
                <td align="right"><b><?php echo  number_format((float)$sales_info->sales_amount_paid-$total, 2, '.', ''); ?></b>
                </td>
            </tr>
          <?php }else{  ?>
            <tr>
                <td colspan="4" align="right"><b>Balance Due</b></td>
                <td align="right"><b><?php echo  number_format((float)$due, 2, '.', ''); ?></b>
                </td>
            </tr>
          <?php } ?>
            <tr>
      ...
      <table width="200" style="font-size:10px;">
              ...
              <tr>
                  <td colspan="3" align="right">Powered By: Sys Dev Ltd.</td>
              </tr>
              <tr>
