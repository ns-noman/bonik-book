                            ...
                            <thead>
                               ...
                               $debit_total +=  $total;
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $ledger->customer_organization;?></td>  
                                    <td><?php echo $ledger->customer_mobile;?></td>  
                                ...
                                <tr>
                                 ...
                                 <?php $return = $this->inventory_model->get_datwise_sales_return($ledger->sales_invoice_date);
                                 if($return){ 
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $preturn->customer_name;?></td> 
                                         <td><?php echo $preturn->customer_organization;?></td>  
                                        <td><?php echo $preturn->customer_mobile;?></td>   
                                ...
                                <?php } } ?>
                                <?php $due_collection = $this->inventory_model->get_datwise_sales_due_collection($ledger->sales_invoice_date); 
                                if ($due_collection) {
                                ...
                                <tr>
                                    <td><?php echo date('d/m/Y', strtotime($duec->sales_payment_date));?></td>  
                                     <td><?php echo $duec->customer_name;?></td> 
                                         <td><?php echo $duec->customer_organization;?></td>  
                                        <td><?php echo $duec->customer_mobile;?></td>     
