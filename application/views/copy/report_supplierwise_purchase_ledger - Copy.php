    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <form class="form-horizontal" action="<?php echo base_url() . "customerwise-purchase-ledger"; ?>" method="post" enctype="multipart/form-data"  role="form" id="purchase_form">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <?php } ?>
                                ...
                                <tr style="font-weight:bold; background-color: #dfdfdf;">
                                    ...
                                    <td align="right"><?php echo number_format((float)($debit_total-$credit_total)-$supplier_balance, 2, '.', '');?></td>  
                                </tr>
                            </thead>
                            <tbody>
