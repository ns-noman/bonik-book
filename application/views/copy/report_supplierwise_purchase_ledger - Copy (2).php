                    ...
                    <center><h4><?php echo $title; ?></h4></center>
                        <table class="table table-bordered table-striped table-hover">
                            <thead>
                                ...
                                <?php $return = $this->inventory_model->get_datwise_purchase_return_supplier($ledger->purchase_invoice_date, $ledger->supplier_id);
                                 if($return){ 
                                ...
                                <?php } } ?>
                            <?php } ?>
                             <?php $due_collection = $this->inventory_model->get_datwise_purchase_due_collection_supplier($ledger->purchase_invoice_date, $ledger->supplier_id); 
                                if ($due_collection) {
                            ...
                            <?php }}}} ?>
                                ...
                                <tr style="font-weight:bold; background-color: #dfdfdf;">
                                    <td align="right" colspan="4">Supplier Balance:</td>  
