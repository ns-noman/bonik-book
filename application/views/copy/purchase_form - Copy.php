                ...
                <table class="table table-bordered table-striped table-hover" id="purchase_table">
                    ...
                    <tfoot style="text-align: right; font-size: 14px;">
                        ...
                        <tr>
                            <td>Paid Amount:</td>
                            <td colspan="4">
                                <input type="number" class="form-control purchase_cal" name="paid_amount" id="paid_amount" step="0.01" value="0" autocomplete="off">
                            </td>
                        </tr>
                        <tr>
                            <td>Due:</td>
                       ...
                       <!--  <tr>
                        ...
                        <tr>
                           <td colspan="10"><button type="submit" class="btn btn-primary">Submit</button></td>
                           <td></td> 
                        </tr>
                    </tfoot>
                </table>
